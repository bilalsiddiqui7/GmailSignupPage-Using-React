        ...
        <div id="maincontainer_change">
            <div id="main_change">
                <div id="container1">
                    ...
                    <div id="signin_fb_change">
                        <div id="signin_fb1_change">
                            <h1>Sign in</h1>
                        </div>
                        <span id="signin_fb2_change">to continue to Gmail</span>
                    </div>
                </div>
                ...
                <div id="learnmore_fb_change">
                    <div>Not your computer? Use Guest mode to sign in privately.</div>
                    <Button id="learnmore_button_change" variant="contained" color="primary">
                        Learn more
                    </Button>
                </div>
