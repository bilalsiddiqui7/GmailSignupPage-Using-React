...
const SignIn = () => {
    return (
        <div id="maincontainer">
            <div id="main">
                <div id="container1">
                    ...
                    <div id="signin_fb">
                        ...
                        <span id="signin_fb2">to continue to Gmail</span>
                    </div>
                </div>
                <div id="email_fb">
                    <TextField id="outlined-basic-d" label="email or phone" variant="outlined" />
                    <div>
                        <Button id="button1" variant="contained" color="primary">
                            Forgot email?
                        </Button>
                    </div>
                </div>
                <div id="learnmore_fb">
                    ...
                    <Button id="learnmore_button" variant="contained" color="primary">
                        Learn more
                    </Button>
                </div>
                <div id="buttons">
                    <Button id="button5_fb" variant="contained" color="primary">
                        Create account
                    </Button>
            ...
            <div id="section2">
                <span id="english_fb">English (United States)</span>
                <span>
